...
class ClassItem extends PureComponent {
  ...
  render() {
    ...
    require('./ReccomendationItem.scss');
    return [
      <div
        ...
        <div className="content">
          <div className="header">
            ...
            <div className="percentage">
              <div className="text">Вам підходить даний інтерес з імовірністю: </div>
              <div className="value">{recommendationInformation.percentage}%</div>
            </div>
          </div>
          <div className="vote">
            <div className="text">Чи ця рекомедація є для Вас актуальною ?</div>
