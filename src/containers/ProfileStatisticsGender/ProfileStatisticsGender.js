...
require('./ProfileStatisticsGender.scss');
...
@withRouter
class ProfileStatisticsGender extends Component {
  static propTypes = {
  ...
  componentDidMount() {
    ...
    fetch(`http://localhost:3030/users_statistics?interestId=${params.id}&dataType=gender`)
          ...
          <div className="profile-content">
            <div className="statistics-container section-item-container">
              ...
              <div className="select-data">
                ...
                <div className="value">
                  <select onChange={this.handleChange} value="gender">
...
export default ProfileStatisticsGender;
